...
def optimize_alertas():
    ...
    with engine.connect() as conn:
        print("1. Re-creando Vista Materializada 'mv_alertas_eventos' con Traducciones a Español Nativas...")
        ...
        sql_view = """
        CREATE MATERIALIZED VIEW "semaforos_PT".mv_alertas_eventos AS (
            WITH traducciones AS (
                SELECT 
                    ...
                    CASE COALESCE(NULLIF(subtipo, ''), tipo)
                        ...
                        WHEN 'HAZARD_ON_ROAD_ICE' THEN 'Hielo en Vía'
                        ...
                        WHEN 'HAZARD_WEATHER_FREEZING_RAIN' THEN 'Lluvia Helada'
                        ...
                        WHEN 'HAZARD_WEATHER_HEAVY_SNOW' THEN 'Nevada Intensa'
                        ...
                        -- Fallbacks a las categorías si el subtipo venía vacío:
                        WHEN 'JAM' THEN 'Tráfico'
                        WHEN 'HAZARD' THEN 'Peligro'
                        WHEN 'ACCIDENT' THEN 'Accidente'
                        WHEN 'ROAD_CLOSED' THEN 'Vía Cerrada'
        ...
        print("2. Re-creando Indice B-Tree de Coordenadas...")
        conn.execute(text('CREATE INDEX idx_mv_alertas_ev_coords ON "semaforos_PT"."mv_alertas_eventos" (latitud_aprox, longitud_aprox);'))
        
        print("3. Re-creando Indice B-Tree de Fechas...")
        conn.execute(text('CREATE INDEX idx_mv_alertas_ev_fecha ON "semaforos_PT"."mv_alertas_eventos" (primera_alerta);'))
